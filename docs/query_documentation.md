...
| **Applied Skills** | • Multi-table JOIN optimization (4+ tables)<br>• UPDATE with referential integrity<br>• Complex SELECT with FK relationships<br>• Data consistency across related entities | [Query 02: Applied Operation](../../query/query_06_item_return_processing.md) |
